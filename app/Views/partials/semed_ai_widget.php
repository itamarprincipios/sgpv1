...
<div class="ai-widget">
    ...
    <div class="ai-chat" id="ianne-chat">
        <div class="ai-message ai-message-assistant">
            <p>Olá! Sou a IANNE, sua assistente pedagógica. 
            <?php if (count($semedSchools) > 1): ?>
                Você pode selecionar uma escola específica ou consultar dados de todas as suas <?= count($semedSchools) ?> escolas.
            <?php endif; ?>
            Como posso ajudar?</p>
        </div>
    </div>
    ...
    <div class="ai-input-container">
        ...
        <button onclick="askIanneSemed()" class="ai-send-btn">
