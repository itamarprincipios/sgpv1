...
<div class="main-container">
    ...
    <div class="dashboard-header">
        <div>
            <h2>Planejamentos da Monitoria</h2>
            <p class="text-muted mb-0">Acompanhamento de entregas de Monitores</p>
        </div>
        <div>
    ...
    <div class="list-section">
        <form method="GET" action="<?= url('supervisor-monitor/plannings') ?>" class="filter-container">
            ...
            <div style="padding-bottom: 2px;">
                 <?php if(!empty($_GET['school_id']) || !empty($_GET['period_name']) || !empty($_GET['status'])): ?>
                    <a href="<?= url('supervisor-monitor/plannings') ?>" class="btn-clear text-decoration-none">
