...
<?php
    ...
    foreach ($groupedData as $className => $records) {
        ...
        // Regex to match "Xº Ano" or "Xº Período" or similar. 
        ...
        // Normalize case to merge "5º Ano" and "5º ano"
                                                        ...
                                                        <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
                                                            ...
                                                            <?php if(isset($rec['status']) && $rec['status'] != 'aprovado'): ?>
                                                                ...
                                                                <form action="<?= @url('school/document/review') ?>" method="POST" style="margin: 0; display: inline-block;">
                                                                 ...
                                                                 <form action="<?= @url('school/document/review') ?>" method="POST" style="margin: 0; display: inline-block;" onsubmit="return confirm('Deseja realmente devolver este planejamento para correção?')">
                                                                     <input type="hidden" name="id" value="<?= @$rec['id'] ?>">
                                                                     <input type="hidden" name="status" value="rejeitado">
                                                                     <button type="submit" class="btn" style="background: #dc3545; color: #fff; font-size: 0.8rem; padding: 6px 12px; border: 1px solid #bd2130; font-weight: bold; cursor: pointer; width: auto; margin: 0;" title="Devolver para Correção">
